...
class CCConnectionsCron extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($school_list as $school) {
            ...
            $connection_log->addLog($school_id, $key_now_num, SchoolConnectionsLog::CONN_CHANGE_LOG, $yesterday);
            ...
            $log =  "school:[$school_name][$school_id]:更新本月可用的并发数:[$key]=>[$month_num_used]".PHP_EOL;
            $this->consoleAndLog($log);
