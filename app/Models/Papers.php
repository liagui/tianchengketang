            ...
            foreach($papers_list as $k=>$v){
                ...
                if(in_array(3,$type_array)){
                    $judge_count     = PapersExam::leftJoin('ld_question_exam','ld_question_exam.id','=','ld_question_papers_exam.exam_id')
                        ->where("ld_question_papers_exam.papers_id" , "=" , $v['papers_id'])->where("ld_question_papers_exam.type" , "=" , 3)->where('ld_question_papers_exam.is_del' , '=' , 0)->where('ld_question_exam.is_del' , '=' , 0)->count();
                    if($judge_count > 0){
                ...
                if(in_array(5,$type_array)){
                    $pack_count     = PapersExam::leftJoin('ld_question_exam','ld_question_exam.id','=','ld_question_papers_exam.exam_id')
                        ->where("ld_question_papers_exam.papers_id" , "=" , $v['papers_id'])->where("ld_question_papers_exam.type" , "=" , 5)->where('ld_question_papers_exam.is_del' , '=' , 0)->where('ld_question_exam.is_del' , '=' , 0)->count();
                    if($pack_count > 0){
                ...
                if(in_array(6,$type_array)){
                    $short_count     = PapersExam::leftJoin('ld_question_exam','ld_question_exam.id','=','ld_question_papers_exam.exam_id')
                        ->where("ld_question_papers_exam.papers_id" , "=" , $v['papers_id'])->where("ld_question_papers_exam.type" , "=" , 6)->where('ld_question_papers_exam.is_del' , '=' , 0)->where('ld_question_exam.is_del' , '=' , 0)->count();
                    if($short_count > 0){
                ...
                if(in_array(7,$type_array)){
                    $material_count     = PapersExam::leftJoin('ld_question_exam','ld_question_exam.id','=','ld_question_papers_exam.exam_id')
                        ->where("ld_question_papers_exam.papers_id" , "=" , $v['papers_id'])->where("ld_question_papers_exam.type" , "=" , 7)->where('ld_question_papers_exam.is_del' , '=' , 0)->where('ld_question_exam.is_del' , '=' , 0)->count();
                    if($material_count > 0){
