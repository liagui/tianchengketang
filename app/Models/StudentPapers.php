...
class StudentPapers extends Model {
    ...
    private static function getStudentBankInfoPage($data){
        ...
        $studentList = self::leftJoin('ld_student_do_title','ld_student_do_title.id','=','ld_student_papers.papers_id')
            ...
            ->select('ld_student_do_title.papers_id','ld_student_papers.create_at','ld_student_papers.bank_id','ld_question_bank.topic_name as bank_name','ld_student_papers.subject_id','ld_question_subject.subject_name','ld_student_papers.papers_id','ld_question_papers.papers_name','ld_question_papers.diffculty','ld_student_papers.student_id','ld_student_papers.answer_score','ld_student_papers.type as ttype')
