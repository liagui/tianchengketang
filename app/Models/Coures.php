...
//                    }
                    ...
                    foreach($list  as $k=>&$v){
                        ...
                        //$list[$k]['a'] = $v['sum_nember']-$v['buy_nember'] <=0 ?0:$v['sum_nember']-$v['buy_nember']; //剩余库存量
                        $list[$k]['surplus'] = 110;
                    }
            }else{
                //自增
            ...
            if($course_method){
                foreach($course_method as $k => $v){
                    if($v['method_id']==1){
                        ...
                        //$arr = Coureschapters::demo($chapters,0,0);
                        //return ['code' => 200 , 'msg' => $arr];
                        if($chapters){
