...
class School extends Model {
    ...
    public static function getSchoolLessonList($data){
        ...
        $natureCourse = CourseSchool::leftJoin('ld_course','ld_course.id','=','ld_course_school.course_id')
                ...
                })->select('ld_course_school.id','ld_course_school.title','ld_course_school.cover','ld_course_school.impower_price as pricing','ld_course_school.status','ld_course_school.course_id','ld_course_school.parent_id','ld_course_school.child_id')
